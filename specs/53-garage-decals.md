...
Create warning signs, hazard stripes, and stencil-style decal planes for garage atmosphere.

### Files to create (ONLY these files):

1. `src/components/features/scene/GarageDecals.tsx`
2. `src/components/features/scene/GarageDecals.test.tsx`

### Instructions

**Create `src/components/features/scene/GarageDecals.tsx`**:
...
**Create `src/components/features/scene/GarageDecals.test.tsx`**:
...
- Hazard stripes, warning signs, and data plaque render from primitives
