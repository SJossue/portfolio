# Visual: Minimap radar component for garage navigation
...
Create a small radar/minimap component that shows a top-down view of the garage with blinking dots for interactable locations. This gives users spatial awareness of where objects are in the 3D space.

### Files to create (ONLY these files):

1. `src/components/features/scene/Minimap.tsx` — NEW file

### Instructions

Create `src/components/features/scene/Minimap.tsx` with this EXACT content:
...
- `Minimap.tsx` exists as a new component
- Shows 4 colored dots corresponding to interactable sections
- Active section dot scales up and glows
