...
export default function NotFound() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center gap-6 bg-[#050510] px-4 text-center">
      <div className="font-mono text-6xl font-bold tracking-wider text-cyan-400">404</div>
      <p className="font-mono text-lg text-white/60">Signal lost. This page does not exist.</p>
      <Link
        href="/"
