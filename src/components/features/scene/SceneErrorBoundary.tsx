      ...
      return (
        ...
        >
          ...
          <button
            ...
            className="rounded-lg border border-cyan-400/30 bg-cyan-500/10 px-4 py-2 font-mono text-xs uppercase tracking-wider text-cyan-300 transition-all hover:border-ccyan-400/60 hover:bg-cyan-500/20"
          >
            Retry
          </button>
        </div>
